...
/** Test of {@link OnPremisesIdeFactoryServlet} functionality. */
@Listeners(value = {MockitoTestNGListener.class})
public class OnPremisesIdeFactoryServletTest {
    ...
    private OnPremisesIdeFactoryServlet servlet;

    @BeforeMethod
    public void setup() throws Exception {
        RuntimeDelegate.setInstance(new RuntimeDelegateImpl());
        this.servlet = new OnPremisesIdeFactoryServlet("/resources/error-factory-creation.html");
    ...
    public void shouldBeAbleToAcceptFactory(String host, String referrer, Factory factory) throws Exception {
        ...
        verify(res).sendRedirect(contains("/ws?factory="+ factory.getId()));
    }
...
//    @Test(dataProvider = "FactoryTypeProvider")
//    public void shouldRedirectToLoginPageDependsOnTypeAndLocationCombination(String factoryParams, String host, String referrer,
//                                                                             Factory factory) throws Exception {
//        when(req.getServerName()).thenReturn(host);
//        when(req.getAttribute("factory")).thenReturn(factory);
//        when(req.getHeader("Referer")).thenReturn(referrer);
//        when(req.getAttribute("factory")).thenReturn(factory);
//        when(user.isTemporary()).thenReturn(true);
//
//        servlet.doGet(req, res);
//
...
//    }
    ...
    public Object[][] factoryTypeProvider() {
        return new Object[][]{
                ...
                //acceptor, named
//                {"codenvy.com", null,
//                 prepareFactory().withPolicies(newDto(Policies.class).withLocation("acceptor").withType("named"))},

                //owner, named
//                {"codenvy.com", null, prepareFactory().withPolicies(
//                        newDto(Policies.class).withLocation("owner").withType("named"))},
};
    }
